...
[Example](https://github.com/nufeng1999/jupyter-MyGjs-kernel/blob/master/example/jupyter_MyGjs_readme.ipynb "Example")
...
cd jupyter_MyGjs_kernel && install_MyGjs_kernel --user
